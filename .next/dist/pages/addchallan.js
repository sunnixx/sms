...
var _class = function (_React$Component) {
  ...
  (0, _createClass3.default)(_class, [{
    ...
    value: function render() {
      return _react2.default.createElement("div", null, _react2.default.createElement(_Head2.default, null), _react2.default.createElement(_TopMenu2.default, null), _react2.default.createElement("div", { className: "page-container" }, _react2.default.createElement("div", { className: "page-content" }, _react2.default.createElement(_Sidebar2.default, { financeActive: "active", challanShow: "block", addStudentActive: "active" }), _react2.default.createElement("div", { className: "content-wrapper" }, _react2.default.createElement("div", { className: "content" }, _react2.default.createElement("div", { className: "panel panel-flat" }, _react2.default.createElement("div", { className: "panel-heading" }, _react2.default.createElement("h5", { className: "panel-title" }, "Add Student Challan")), _react2.default.createElement("div", { className: "panel-body" }, _react2.default.createElement("form", { className: "form-horizontal", method: "post", action: "/addchallan" }, _react2.default.createElement("fieldset", { className: "content-group" }, _react2.default.createElement("legend", { className: "text-bold" }, "Basic Information"), _react2.default.createElement("div", { className: "form-group" }, _react2.default.createElement("label", { className: "control-label col-lg-2" }, "First Name ", _react2.default.createElement("span", { style: { color: "red" } }, "*")), _react2.default.createElement("div", { className: "col-lg-10" }, _react2.default.createElement("input", { type: "text", className: "form-control", name: "fname", required: true }))), _react2.default.createElement("div", { className: "form-group" }, _react2.default.createElement("label", { className: "control-label col-lg-2" }, "Last Name ", _react2.default.createElement("span", { style: { color: "red" } }, "*")), _react2.default.createElement("div", { className: "col-lg-10" }, _react2.default.createElement("input", { type: "text", className: "form-control", name: "lname", required: true }))), _react2.default.createElement("div", { className: "form-group" }, _react2.default.createElement("label", { className: "control-label col-lg-2" }, "Grade ", _react2.default.createElement("span", { style: { color: "red" } }, "*")), _react2.default.createElement("div", { className: "col-lg-10" }, _react2.default.createElement("input", { type: "text", className: "form-control", name: "grade", required: true }))), _react2.default.createElement("div", { className: "form-group" }, _react2.default.createElement("label", { className: "control-label col-lg-2" }, "Guardian's Name ", _react2.default.createElement("span", { style: { color: "red" } }, "*")), _react2.default.createElement("div", { className: "col-lg-10" }, _react2.default.createElement("input", { type: "text", className: "form-control", name: "guardian", required: true }))), _react2.default.createElement("div", { className: "form-group" }, _react2.default.createElement("label", { className: "control-label col-lg-2" }, "Amount ", _react2.default.createElement("span", { style: { color: "red" } }, "*")), _react2.default.createElement("div", { className: "col-lg-10" }, _react2.default.createElement("input", { type: "number", className: "form-control", name: "amount", required: true })))), _react2.default.createElement("div", { className: "text-right" }, _react2.default.createElement("button", { type: "submit", className: "btn btn-primary legitRipple" }, "Submit ", _react2.default.createElement("i", { className: "icon-arrow-right14 position-right" })))))))))));
    }
  }]);
